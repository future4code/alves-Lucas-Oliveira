...
RESPOSTA 
Será impresso todos  os itens, index e arrays de usuarios.
...
/*    a) O que vai ser impresso no console?
RESPOSTA
Será impresso todos os itens nome do array
EX: ["Amanda Rangel", "Laís Petra", "Letícia Chijo"]
...
/*   a) O que vai ser impresso no console?
RESPOSTA
Será impresso todos os itens apedido (item.apelido) diferente de "Chijo"
EX  0: {nome: 'Amanda Rangel', apelido: 'Mandi'}
...
A mensagem deve ser: "Você ganhou um cupom de desconto de 10% para tosar o/a `[NOME]`!"*/
    ...
    const mensagemPoodles = pets.filter((racaPoodles) =>{
        return racaPoodles.raca === "Poodle"
        }).map((racaPoodles) => {
            return`Você ganhou um cupom de desconto de 10% para tosar o/a ${racaPoodles.nome}!`
        })
...
/*2. Dado o seguinte array de produtos, realize as operações pedidas nos itens abaixo utilizando as funções de array **map** e **filter:** */
    ...
    const produtosCategoria = produtos.map((item, index, array) => {
    ...
    //        return item.nome.replaceAll() === "Ypê"
    //          }).map((item) => {
    //              return item.nome
    //              })
